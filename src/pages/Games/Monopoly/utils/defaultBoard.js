export const defaultBoard = [
  ...
  { id: 7, name: "Шанс", type: "chance", color: "#fff4b6" },
  ...
  { id: 10, name: "В'язниця / Просто в гостях", type: "jail", color: "#cdb4b4" },
  ...
  { id: 17, name: "Скриня громади", type: "chest", color: "#ddf3f7", gift: 500 },
  ...
  { id: 22, name: "Шанс", type: "chance", color: "#fff4b6" },
  ...
  { id: 30, name: "Іди у в'язницю", type: "go_to_jail", color: "#cdb4b4" },
  ...
  { id: 33, name: "Скриня короля", type: "chest", color: "#ddf3f7", gift: 1000 },
  ...
  { id: 36, name: "Шанс", type: "chance", color: "#fff4b6" },
  ...
  { id: 39, name: "Бродвей", type: "property", color: "", price: 400, rent: 800, owner: null },
];
