...
export const Dices = ({ dice = [], ifCurrentPlayer, rolling, handleRollDice, auction }) => {
  const diceImage = [
  ...
  return (
    <div className={style.roll}>
      ...
      {ifCurrentPlayer && !rolling && !auction && <button onClick={handleRollDice}>Кинути кубики 🎲</button>}
    </div>
  );
};
